...
from lab.llm.prompt import build_prompt
from lab.llm.cohere_chain import run_llm
from lab.llm.validate import validate_plan
...
def node_validate(state: State) -> State:
    ...
    state["plan_validated"] = validated.model_dump()
    return state
